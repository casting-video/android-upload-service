...
public final class UploadService extends Service {
    ...
    // for single notification mode
    private static SingleNotification.Delegate singleNofiticationDelegate = null;
    protected SingleNotification singleNotification = null;
    ...
    public void onCreate() {
        ...
        // Create single notification processor
        if (singleNofiticationDelegate != null) {
            singleNotification = new SingleNotification(this, singleNofiticationDelegate);
        }
     ...
     * TODO annotation
     */
    public static void enableSingleNotification(SingleNotification.Delegate delegate) {
        singleNofiticationDelegate = delegate;
    }

    /**
     * TODO annotation
     */
    public static boolean isSingleNotificationEnabled() {
        return singleNofiticationDelegate != null;
    }
}
